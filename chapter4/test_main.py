...
# testowanie punktu końcowego kontroli kondycji
def test_read_main():
    response = client.get("/")
    assert response.status_code == 200
    assert response.json() == {"message": "Kontrola kondycji API zakończona sukcesem"}

# test punktu końcowego /v0/players/
...
# test punktu końcowego /v0/performances/
